...
public class FavoritesContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, FavoritesContract.MovieEntry.PATH_FAVORITES, CODE_WEATHER);
         ...
         */
        matcher.addURI(authority, FavoritesContract.MovieEntry.PATH_FAVORITES + "/#", CODE_WEATHER_WITH_DATE);
